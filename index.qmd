...
map = {
  ...
  const conf_data_w_xy = raw_points;
  ...
  function boxingForce() {
    ...
    const sim = d3.forceSimulation(conf_data_w_xy);
      sim.force('many', d3.forceManyBody().strength(0.25).distanceMax(10))
        .force("collide", d3.forceCollide().radius(6).strength(0.3))
  ...
  console.log(color_town('Lund'))
    ...
    function draw() {
        svg.selectAll("circle")
                ...
                .attr("cy", d => d.y)
                .attr("fill", d => color(d))
                .style('stroke', d => d3.color(color_town(d.town)))
    }
